...
export default (req, res) => {
  ...
  let cmd = `docker run --rm -v /tmp/:/API/tmp/ -v /keys:/API/keys -w /API rnix/openssl-gost cat .${fileName} | openssl smime -sign -binary -outform DER -noattr -signer ./keys/cert.pem -inkey ./keys/key.pem -out .${fileName}.p7b && cat .${fileName}.p7b | base64`
